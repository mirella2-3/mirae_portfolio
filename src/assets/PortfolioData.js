...
const PortfolioData = [
    {
        id: 1,
        title: 'Round Lab',
        desc: '라운드랩 공식 홈페이지 리뉴얼 프로젝트. 기존 진부한 레이아웃을 현대적이고 직관적인 구조로 재구성. 최신 UI/UX 트렌드 반영해서 사용자가 직관적으로 탐색할 수 있도록 디자인 개선, 깔끔하고 세련된 인터페이스로 브랜드 이미지 강화함. ',
        ...
        tool: ['4인 프로젝트', '메인 코더', 'React', 'Redux', 'Sass'],
    },
    {
        id: 2,
        title: 'Nintendo',
        desc: '닌텐도 공식 홈페이지 리뉴얼 프로젝트. 기존의 투박한 헤더를 세련되고 아름다운 디자인으로 개선. 헤더를 중심으로 전체적인 디자인을 현대적인 스타일로 다듬고, 그 안에 있는 콘텐츠들을 더욱 눈에 띄게 배치해 사용자 경험을 강화함. 추가로, 스와이퍼와 동영상을 활용해 사용자 흥미를 유도하고, 사이트 탐색을 더 재미있고 직관적으로 만듦.',
        ...
        tool: ['2인 프로젝트', '메인 코더', 'React', 'Redux', 'Sass'],
    },
    {
        id: 3,
        title: 'MuseOn',
...

    {
        ...
        tool: ['4인 프로젝트', '코더', 'HTML', 'CSS', 'JavaScript'],
    },
    {
        id: 5,
        title: 'Tim Hortons ',
        ...
        tool: ['3인 프로젝트', '메인 디자인', 'Figma', 'Mobile'],
    },
    // {
    //     id: 6,
    //     title: 'KAC',
